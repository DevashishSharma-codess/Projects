...
import {
    ...
    buildSparkPath,
    type GraphPoint,
} from "../data/moodTrackerData";
import { MoodLogModal, BreathingModal } from "../MoodTrackerModals/MoodTrackerModals";
import { MoodMusicWidget } from "../MoodMusicWidget/MoodMusicWidget";
import { MoodCalendarWidget } from "../MoodCalendarWidget/MoodCalendarWidget";
import { DashboardMoodLogger } from "../DashboardMoodLogger/DashboardMoodLogger";
import { MoodReportsWidget } from "../MoodReportsWidget/MoodReportsWidget";
...
export default function MoodTracker() {
    ...
    const logsArray = Object.values(logs).sort((a, b) => (a.timestamp || 0) - (b.timestamp || 0));

    const getGraphTimeframePoints = () => {
    ...
    const graphTimeframePoints = getGraphTimeframePoints();
    ...
    const moodCounts: Record<string, number> = { radiant: 0, peaceful: 0, focused: 0, energetic: 0, stressed: 0, low: 0 };
    logsArray.forEach((l) => { moodCounts[l.moodKey] = (moodCounts[l.moodKey] || 0) + 1; });

    const dominantMoodKey = Object.entries(moodCounts).sort((a, b) => b[1] - a[1])[0]?.[0] || "peaceful";
    ...
    return (
        ...
        >
            {futureDateToast && (
                <div className="mood-future-toast">
            ...
            <div className="mood-tracker-header">
                <h2 className="mood-tracker-main-title">
                    Mood & Wellness <span className="mood-tracker-serif-title">Analytics</span>
                </h2>
                <p className="mood-tracker-subtext">
            ...
            <div className="mood-tracker-wrapper">
                ...
                <div className="mood-left-dock">
                    <div className="mood-left-dock-btn-group">
                        {[
                            ...
                            return (
                                <button
                                    ...
                                    title={tab}
                                    className={`mood-left-dock-btn ${isActive ? "active" : "inactive"}`}
                                >
                    ...
                    <div className="mood-left-dock-avatar">
                        <User size={16} color="#334155" />
                    </div>
                </div>

                {/* MAIN MORPHED LIGHT GLASS WINDOW CONTAINER */}
                <div className="mood-tracker-window">
                    {/* Top Header Window Bar */}
                    <div className="mood-top-window-bar">
                        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                            <div className="mood-window-dots">
                                <div className="mood-dot-1" />
                                <div className="mood-dot-2" />
                                <div className="mood-dot-3" />
                            </div>
                        </div>

                        <div className="mood-top-tab-switcher">
                            {[
                                ...
                                return (
                                    <button
                                        ...
                                        className={`mood-top-tab-btn ${isActive ? "active" : "inactive"}`}
                                    >
                        ...
                        <div className="mood-user-profile-badge">
                            <div className="mood-user-avatar">
                                JS
                            </div>
                    ...
                    <div className="mood-filter-pills-row">
                        <button
                            onClick={() => setCategoryFilter("all")}
                            className={`mood-filter-pill ${categoryFilter === "all" ? "active" : "inactive"}`}
                        >
                            All Categories
                        </button>
                        {MOOD_OPTIONS.map((m) => {
                            ...
                            return (
                                <button
                                    ...
                                    className={`mood-filter-pill ${isSel ? "active" : "inactive"}`}
                                >
                                    {m.label}
                                </button>
                            );
                    ...
                    {activeNavTab === "Mood Logs" && (
                        <div className="mood-logs-table-card">
                            <div className="mood-logs-table-header">
